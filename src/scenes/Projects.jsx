        ...
        <section id="projects" className="py-48" >
            ...
            <div className="flex justify-center">
                ...
                >
                    ...
                    <Project title="Arte de Caderno" subtitle="Creating a portal with two other students for a project developed inside the College. We are still building it, using ReactJS for the front-end and Node.js for the back-end" />
                    
                    <Project title="BR finanças" subtitle="A finance controller named BR Finanças. Technologies used: HandleBars, NodeJS and MySQL." />

                    <Project title="Patinhas Felizes" subtitle="A menagement system for a fictitious animal shelter, where the workers can manage animal adoptions and donations. Technologies used: Handlebars, NodeJS and MySQL." />
                </motion.div>
            </div>
